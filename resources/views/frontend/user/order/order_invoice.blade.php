...
<body style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: 12px;">
    ...
    <table width="100%" style="line-height: 1.2;">
        <tr style="font-size: 13px">
            ...
            <td width="40%">: <strong>AM STORE</strong> | esalza@gmail.com</td>
    ...
    <p style="line-height: 5px">
        Silakan hubungi <strong>AM STORE Care</strong> apabila kamu membutuhkan bantuan.
